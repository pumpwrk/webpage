...
| [003](./epics/003-pug-templates.md) | Migrar `.html` → `.pug` con layout extend | ✅ **Completada** |
| [004](./epics/004-build-script.md) | Crear `build.js` CLI + `package.json` | ✅ **Completada** |
...
- Épicas creadas: 5/5
- Completadas: 4
- En curso: ninguna (épica 004 terminada — listo para 005)
